      ...
      <div className="flex items-center justify-between p-6 border-b border-gray-100">
        <div className="flex items-center gap-3">
          <div className={cx('p-2 rounded-xl border', mode === 'history' ? 'bg-violet-500/10 border-violet-500/20' : 'bg-emerald-500/10 border-emerald-500/20')}>
            {mode === 'history' ? <History className="w-5 h-5 text-violet-600" /> : <Edit className="w-5 h-5 text-emerald-600" />}
          </div>
        ...
        {mode === 'history' ? (
          <div className="space-y-2">
            {historyLog.map((log, i) => (
              <div key={i} className="flex items-center justify-between p-3 bg-[#F7F9FC] rounded-xl">
                <div>
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pt-4">
          <div>
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-xs font-bold uppercase tracking-widest text-violet-600">Inventory</span>
            </div>
          ...
          <div className="flex flex-col sm:flex-row justify-between gap-4 p-5 border-b border-gray-100">
            <div className="relative flex-1 max-w-sm">
              ...
              <input type="text" placeholder="Search products or locations..."
                className="w-full bg-[#F7F9FC] rounded-xl pl-10 pr-4 py-2.5 text-sm text-[#1F2937] placeholder-gray-400 focus:outline-none border border-gray-200"
                    ...
                    <tr key={item.id} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        <div className="flex gap-2">
                          <button onClick={() => setModalState({ item, mode: 'history' })} className="text-xs font-bold text-violet-600 hover:text-[#1F2937] transition-colors flex items-center gap-1">
