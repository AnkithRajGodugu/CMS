  ...
  const features = [
    {
      ...
      description: 'Specialized workflows and features tailored for banking, healthcare, logistics, and content creation.',
      icon: (
    ...
    },
    {
      ...
      description: 'Get instant insights with powerful dashboards and reporting tools for data-driven decisions.',
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      title: 'Cloud-Native',
      description: 'Built for the cloud with automatic scaling, backups, and 99.9% uptime guarantee.',
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-base-content/70 max-w-3xl mx-auto">
            Everything you need to manage customers effectively, backed by cutting-edge technology.
          </p>
        </div>
